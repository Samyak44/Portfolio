...
const ServiceCard = ({ index, title, icon }) => {
  return (
    <Tilt className="xs:w-[250px] sm:w-[280px] md:w-[250px] w-full">
      <motion.div
      ...
      >
        <div
          ...
          className='bg-tertiary rounded-[20px] py-5 px-8 sm:px-12
